  ...
  <div class="uk-container">
    <div class="uk-grid uk-child-width-expand" uk-grid>
      ...
      <div class="uk-text-right">
        <a href="<?php echo $redux_demo[socialVk]; ?>" class="uk-icon-button uk-margin-small-right" uk-icon="icon: google"></a>
        <a href="<?php echo $redux_demo[socialOk]; ?>" class="uk-icon-button  uk-margin-small-right" uk-icon="icon: facebook"></a>
        <a href="<?php echo $redux_demo[socialFb]; ?>" class="uk-icon-button" uk-icon="icon: instagram"></a>
      </div>      
    </div>
  </div>
